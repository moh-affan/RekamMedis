                       ...
                       <form action="?act=edit_action" name="modal_popup" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="ID_PASIEN" type="hidden" class="form-control" placeholder="Nama Lengkap" value="<?php echo $pasien['ID_PASIEN'] ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Nama</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="METODE_PEMBAYARAN" type="text" class="form-control" placeholder="Metode Pembayaran" value="<?php echo $pasien['METODE_PEMBAYARAN'] ?>" />
                                </div>
                            </div>
